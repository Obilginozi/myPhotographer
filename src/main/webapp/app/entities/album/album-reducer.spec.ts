...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './album.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ALBUM_LIST actions', async () => {
    ...
    it('dispatches FETCH_ALBUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ALBUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ALBUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ALBUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ALBUM actions', async () => {
      const expectedActions = [
        {
