...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './file.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FILE_LIST actions', async () => {
    ...
    it('dispatches FETCH_FILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FILE actions', async () => {
      const expectedActions = [
        {
