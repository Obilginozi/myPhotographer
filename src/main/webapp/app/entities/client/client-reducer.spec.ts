...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './client.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLIENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_CLIENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CLIENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CLIENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CLIENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CLIENT actions', async () => {
      const expectedActions = [
        {
