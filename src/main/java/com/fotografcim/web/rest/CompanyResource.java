...
import com.fotografcim.repository.CompanyRepository;
...
/**
 * REST controller for managing {@link com.fotografcim.domain.Company}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CompanyResource {
    ...
    public CompanyResource(UserService userService, CompanyRepository companyRepository) {
    ...
    public ResponseEntity<Company> updateCompany(@PathVariable(value = "id", required = false) final UUID id, @RequestBody Company company)
    ...
    public ResponseEntity<Company> partialUpdateCompany(
        ...
        Optional<Company> result = companyRepository
            ...
            .map(existingCompany -> {
                ...
                if (company.getCompanyMail() != null) {
                    existingCompany.setCompanyMail(company.getCompanyMail());
                }
    ...
    @GetMapping("/usersCompanie/{id}")
    public Company getCompanyByUser(@PathVariable Long id) {
        log.debug("REST request to get Company : {}", id);
