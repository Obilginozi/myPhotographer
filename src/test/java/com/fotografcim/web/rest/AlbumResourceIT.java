...
class AlbumResourceIT {
    ...
    public static Album createEntity(EntityManager em) {
        Album album = new Album().token(DEFAULT_TOKEN).createDate(DEFAULT_CREATE_DATE);
        return album;
    }
    ...
    public static Album createUpdatedEntity(EntityManager em) {
        Album album = new Album().token(UPDATED_TOKEN).createDate(UPDATED_CREATE_DATE);
        return album;
    }
    ...
    void createAlbum() throws Exception {
        ...
        assertThat(testAlbum.getToken()).isEqualTo(DEFAULT_TOKEN);
        assertThat(testAlbum.getCreateDate()).isEqualTo(DEFAULT_CREATE_DATE);
    }
    ...
    void getAllAlbums() throws Exception {
        ...
        restAlbumMockMvc
            ...
            .andExpect(jsonPath("$.[*].id").value(hasItem(album.getId().toString())))
    ...
    void getAlbum() throws Exception {
        ...
        restAlbumMockMvc
            ...
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.id").value(album.getId().toString()))
    ...
    void getNonExistingAlbum() throws Exception {
        // Get the album
        restAlbumMockMvc.perform(get(ENTITY_API_URL_ID, UUID.randomUUID().toString())).andExpect(status().isNotFound());
    }
    ...
    void putNewAlbum() throws Exception {
        ...
        updatedAlbum.token(UPDATED_TOKEN).createDate(UPDATED_CREATE_DATE);
        ...
        Album testAlbum = albumList.get(albumList.size() - 1);
        assertThat(testAlbum.getToken()).isEqualTo(UPDATED_TOKEN);
        assertThat(testAlbum.getCreateDate()).isEqualTo(UPDATED_CREATE_DATE);
    }
    ...
    void partialUpdateAlbumWithPatch() throws Exception {
        ...
        partialUpdatedAlbum.createDate(UPDATED_CREATE_DATE);
    ...
    void fullUpdateAlbumWithPatch() throws Exception {
        ...
        partialUpdatedAlbum.token(UPDATED_TOKEN).createDate(UPDATED_CREATE_DATE);
    ...
    void deleteAlbum() throws Exception {
        ...
        // Delete the album
        restAlbumMockMvc
            .perform(delete(ENTITY_API_URL_ID, album.getId().toString()).accept(MediaType.APPLICATION_JSON))
