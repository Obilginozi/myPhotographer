...
import com.fotografcim.IntegrationTest;
import com.fotografcim.domain.Client;
import com.fotografcim.repository.ClientRepository;
...
class ClientResourceIT {
    ...
    private static final String DEFAULT_CLIENT_SURNAME = "AAAAAAAAAA";
    private static final String UPDATED_CLIENT_SURNAME = "BBBBBBBBBB";

    private static final String DEFAULT_CLIENT_MAIL = "AAAAAAAAAA";
    private static final String UPDATED_CLIENT_MAIL = "BBBBBBBBBB";
    ...
    public static Client createEntity(EntityManager em) {
        Client client = new Client()
            ...
            .clientSurname(DEFAULT_CLIENT_SURNAME)
            .clientMail(DEFAULT_CLIENT_MAIL)
    ...
    public static Client createUpdatedEntity(EntityManager em) {
        Client client = new Client()
            ...
            .clientSurname(UPDATED_CLIENT_SURNAME)
            .clientMail(UPDATED_CLIENT_MAIL)
    ...
    void createClient() throws Exception {
        ...
        assertThat(testClient.getClientSurname()).isEqualTo(DEFAULT_CLIENT_SURNAME);
        assertThat(testClient.getClientMail()).isEqualTo(DEFAULT_CLIENT_MAIL);
    ...
    void getAllClients() throws Exception {
        ...
        restClientMockMvc
            ...
            .andExpect(jsonPath("$.[*].clientSurname").value(hasItem(DEFAULT_CLIENT_SURNAME)))
            .andExpect(jsonPath("$.[*].clientMail").value(hasItem(DEFAULT_CLIENT_MAIL)))
    ...
    void getClient() throws Exception {
        ...
        restClientMockMvc
            ...
            .andExpect(jsonPath("$.clientSurname").value(DEFAULT_CLIENT_SURNAME))
            .andExpect(jsonPath("$.clientMail").value(DEFAULT_CLIENT_MAIL))
    ...
    void putNewClient() throws Exception {
        ...
        assertThat(testClient.getClientSurname()).isEqualTo(UPDATED_CLIENT_SURNAME);
        assertThat(testClient.getClientMail()).isEqualTo(UPDATED_CLIENT_MAIL);
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.clientName(UPDATED_CLIENT_NAME).clientSurname(UPDATED_CLIENT_SURNAME).clientMail(UPDATED_CLIENT_MAIL);
