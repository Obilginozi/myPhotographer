...
class FileResourceIT {
    ...
    public static File createEntity(EntityManager em) {
        File file = new File().name(DEFAULT_NAME).photo(DEFAULT_PHOTO).photoContentType(DEFAULT_PHOTO_CONTENT_TYPE);
        return file;
    }
    ...
    public static File createUpdatedEntity(EntityManager em) {
        File file = new File().name(UPDATED_NAME).photo(UPDATED_PHOTO).photoContentType(UPDATED_PHOTO_CONTENT_TYPE);
        return file;
    }
    ...
    void createFile() throws Exception {
        ...
        assertThat(testFile.getPhoto()).isEqualTo(DEFAULT_PHOTO);
        assertThat(testFile.getPhotoContentType()).isEqualTo(DEFAULT_PHOTO_CONTENT_TYPE);
    }
    ...
    void putNewFile() throws Exception {
        ...
        updatedFile.name(UPDATED_NAME).photo(UPDATED_PHOTO).photoContentType(UPDATED_PHOTO_CONTENT_TYPE);
        ...
        assertThat(testFile.getPhoto()).isEqualTo(UPDATED_PHOTO);
        assertThat(testFile.getPhotoContentType()).isEqualTo(UPDATED_PHOTO_CONTENT_TYPE);
    }
    ...
    void fullUpdateFileWithPatch() throws Exception {
        ...
        partialUpdatedFile.name(UPDATED_NAME).photo(UPDATED_PHOTO).photoContentType(UPDATED_PHOTO_CONTENT_TYPE);
    ...
    void deleteFile() throws Exception {
        ...
        // Delete the file
        restFileMockMvc
            .perform(delete(ENTITY_API_URL_ID, file.getId().toString()).accept(MediaType.APPLICATION_JSON))
